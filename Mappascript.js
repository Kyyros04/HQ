...
function oss(imm){
	var cod=imm;
	var url= `<img src="Cards/${imm.toString()}.png" alt="Devi aver dimenticato cosa stavi cercando" height="250px" width="460px">`
...
function aggiungiitem(){
	...
	var riga=`<td id="n${n.toString()}" onclick='oss("${item.nome}")'><div class="coldiario">-${item.nome}</div></td><td><input type='button' value='-' onclick='rem("n${n.toString()}")'></button></td></tr>`
